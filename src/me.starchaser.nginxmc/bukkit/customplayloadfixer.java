...
public class customplayloadfixer {
    ...
    public static void customPlayloadOnEnable() {
        ...
        ProtocolLibrary.getProtocolManager().addPacketListener(new PacketAdapter(core.getNginxMC, new PacketType[]{Client.CUSTOM_PAYLOAD}) {
            public void onPacketReceiving(PacketEvent event) {
                customplayloadfixer.checkPacket(event);
            }
        });
        Bukkit.getScheduler().runTaskTimer(core.getNginxMC, () -> {
    ...
    public static void customPlayloadOnDisable() {
        ProtocolLibrary.getProtocolManager().removePacketListeners(core.getNginxMC);
    }
        ...
        if (lastPacket == -2L) {
            ...
            if ("MC|BSign".equals(name) || "MC|BEdit".equals(name) || "REGISTER".equals(name)) {
                try {
                    ...
                    Bukkit.getScheduler().runTask(core.getNginxMC, () -> {
